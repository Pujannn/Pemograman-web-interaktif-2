<?php 
$irvine_news_featured_news_disabled = get_theme_mod('newsexo_featured_news_disabled', true);
$irvine_news_featured_news_area_title = get_theme_mod('newsexo_featured_news_area_title', __('Most Popular', 'newsexo'));
$featured_post = '3';
$irvine_news_theme_featured_news_category = get_theme_mod('newsexo_theme_featured_news_category');
if($irvine_news_featured_news_disabled == true): ?>
		...
		<div class="container-full">
			...
			<div class="row g-lg-2 align-self-center wow animate fadeInUp" data-wow-delay=".3s">
				<div class="col-12">
					...
					<h5 class="f-heading"><?php echo esc_html($irvine_news_featured_news_area_title);?></h5>
					</span>
				</div>
			</div>	
			...
			<div class="row g-lg-2">
					...
					<?php		$post_args = array( 'post_type' => 'post', 'category__in' => $irvine_news_theme_featured_news_category, 'post__not_in'=>get_option("sticky_posts"), 'posts_per_page'      => $featured_post,) ;
