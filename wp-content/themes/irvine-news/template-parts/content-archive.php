...
?>
	<div class="col-lg-4 col-md-12 col-sm-12">
		<article class="post grid-view-news-area vrsn-two wow animate fadeInUp" data-wow-delay=".3s" <?php post_class(); ?>>		
				   <?php 
			...
			?>		
					<figcaption class="post-content">
						...
						<div class="entry-meta align-self-center">
							...
							<span class="comment-links"><i class="fa-solid fa-comment-dots"></i><a href="<?php the_permalink(); ?>#respond"><?php echo get_comments_number(); ?></a></span>
						</div>	
						<div class="entry-content">
							<?php newsexo_posted_content(); ?>
							<?php if (get_theme_mod('newsexo_blog_content','excerpt') == "excerpt") { ?>
							<a href="<?php the_permalink();?>" class="more-link"><?php echo esc_html(get_theme_mod('newsexo_read_more_button_text', __('Read More', 'irvine-news'))); ?></a>
							<?php } ?>
							<?php wp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Pages:', 'irvine-news' ), 'after'  => '</div>', ) ); ?>
						</div>
					</figcaption>	
