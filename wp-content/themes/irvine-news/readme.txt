...
Irvine News WordPress Theme, Copyright (C) 2023-2024, ThemeArile
Irvine News WordPress Theme is distributed under the terms of the GNU GPL
...
* Owl Carousel, (C) 2013 - 2017, David Deutsch
Source: https://github.com/OwlCarousel2/OwlCarousel2/
License: [MIT](http://opensource.org/licenses/MIT)

* WPTT Webfont Loader, 2020 Ari Stathopoulos, WordPress Themes Team
...
* Image for Screenshot Image, Credit CC0 Public Domain
  ...
  Source: https://pxhere.com/en/photo/77300

== Images ==

* Image used in screenshot & mockup, License CC0 Public Domain

https://stocksnap.io/photo/Businessman-Contact-QCHFC9BKIF
https://stocksnap.io/photo/laptop-typing-YBKJ1G35EX
https://stocksnap.io/photo/architecture-building-RHCCS9D0RM
https://stocksnap.io/photo/boyfriend-girlfriend-OIOWWM21KW

* Image used in header background image, License CC0 Public Domain

https://pxhere.com/en/photo/1158866

== Changelog ==

@Version 1.5
* We added the default color of anchor tag in the wp-block-embed-youtube widget in sidebar widget area.

@Version 1.4
* We added the default color of anchor tag in the wp-block-media-text for the footer widgets area.

@Version 1.3
* Fixed footer copyright issue.

@Version 1.2
* We added the background color of the wp-block-file download button in the sidebar widget area.
